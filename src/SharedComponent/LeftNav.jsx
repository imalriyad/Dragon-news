...
const LeftNav = () => {
  const { githubSignIn, googleSignIn } = useContext(DataContext);
  ...
  return (
    <div>
      ...
      <div className="flex-col flex">
        <button onClick={googleSignInHandler} className="btn btn-outline my-3">
      ...
      <div className="bg-[#F3F3F3] p-6 rounded space-y-7">
        ...
        <img src="https://i.ibb.co/BNK2nVH/qZone1.png" className="mx-auto cursor-pointer" alt="" />
        <img src="https://i.ibb.co/MnsFJFd/qZone2.png" className="mx-auto cursor-pointer" alt="" />
        <img src="https://i.ibb.co/B6LFBjh/qZone3.png" className="mx-auto cursor-pointer" alt="" />
      </div>
      <Toaster/>
    </div>
  );
